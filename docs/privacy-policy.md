...
Mile Converter is a free Android application that converts distances between miles, kilometers, and nautical miles.
...
Mile Converter does not request any Android permissions.

## Third-Party Services

Mile Converter does not integrate any third-party SDKs, analytics libraries, or advertising networks.
